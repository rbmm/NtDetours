...
static unsigned char flags_table[256] = 
{
    ...
    /* A0 */    OP_DATA_I16_I32_I64,
    /* A1 */    OP_DATA_I16_I32_I64,
    /* A2 */    OP_DATA_I16_I32_I64,
...
{
	/* init output data */
	__stosb( (unsigned char *)ld, 0, sizeof(ldasm_data) );

    uint8_t *p = (uint8_t*)code;
    uint8_t s = 0, op, f;
    uint8_t rexw = 0, pr_66 = 0, pr_67 = 0;
    ...
    if (rexw && (f & OP_DATA_I16_I32_I64))
		ld->imm_size = 8;
    else if (f & (OP_DATA_I16_I32|OP_DATA_I16_I32_I64))
